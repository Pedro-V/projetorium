...
urlpatterns = [
    ...
    path('turma/<int:id_turma>/escolher_projeto', Escolher_projeto.as_view(), name='escolher_projeto'),
    path('turma/<int:id_turma>/escolher_projeto/escolher_membros_grupo', Escolher_membros_grupo.as_view(), name='escolher_membros_grupo'),
