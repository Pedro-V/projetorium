# Generated by Django 4.2.5 on 2024-03-27 16:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('membros', models.ManyToManyField(db_table='app_forma', to='app.aluno')),
            ],
        ),
        migrations.CreateModel(
            name='Professor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Concluido', 'Concluido'), ('Cancelado', 'Cancelado'), ('Suspenso', 'Suspenso'), ('Em progresso', 'Em Progresso')], default='Em progresso', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alunos', models.ManyToManyField(db_table='app_estuda', to='app.aluno')),
